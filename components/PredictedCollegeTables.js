        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((item, index) => (
            <tr key={index} className={index % 2 === 0 ? 'bg-gray-100' : 'bg-white'}>
              <td className="px-6 py-4 whitespace-normal text-sm font-medium text-gray-900">{item["College Rank"]}</td>
              <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">{item["State"]}</td>
              ...
              <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">{item["Opening Rank"]}</td>
              <td className="px-6 py-4 whitespace-normal text-sm text-gray-500">{item["Closing Rank"]}</td>
              <td className="px-6 py-4 whitespace-nromal text-sm text-gray-500">{item["Quota"]}</td>
            </tr>
          ))}
        </tbody>
      </table>
